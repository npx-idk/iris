...
export class ProjectsController {
  ...
  inviteMember(@Param("id") id: string, @Body() dto: InviteMemberDto) {
    return this.members.invite(id, dto)
  }
  ...
  updateMemberRole(
    ...
    return this.members.updateRole(id, user.id, memberId, dto)
  }
  ...
  removeMember(
    ...
    return this.members.remove(id, user.id, memberId)
  }
  ...
  createApiKey(
    ...
    return this.apiKeys.create(id, user.id, dto)
  }
