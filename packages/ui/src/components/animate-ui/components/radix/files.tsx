...
import { Folder01Icon, FolderOpenIcon, File01Icon } from '@hugeicons/core-free-icons';
      ...
      <FolderTriggerPrimitive className="w-full text-start">
        <FolderHighlightPrimitive>
          <FolderPrimitive className="flex items-center justify-between gap-2 p-2 pointer-events-none">
            ...
            >
              <FolderIconPrimitive
                closeIcon={<HugeiconsIcon icon={Folder01Icon} className="size-4" />}
                openIcon={<HugeiconsIcon icon={FolderOpenIcon} className="size-4" />}
              />
              <FileLabelPrimitive
